...
<h1>セレクト問題</h1><form action="{{ route('post_question_edit',['id' => $questionnaire->id, 'questionId'=>$question->id, 'type' => $question->mtb_question_type_id, 'action' => 'edit']) }}" method="post">
  @csrf
